...
type CloudwatchEventBusItem struct {
	Address                      *string
	Region                       *string
	MonthlyArchiveProcessingGb   *int64 `infracost_usage:"monthly_archive_processing_gb"`
	ArchiveStorageGb             *int64 `infracost_usage:"archive_storage_gb"`
...
var CloudwatchEventBusItemUsageSchema = []*schema.UsageItem{{Key: "monthly_archive_processing_gb", ValueType: schema.Int64, DefaultValue: 0}, {Key: "archive_storage_gb", ValueType: schema.Int64, DefaultValue: 0}, {Key: "monthly_schema_discovery_events", ValueType: schema.Int64, DefaultValue: 0}, {Key: "monthly_custom_events", ValueType: schema.Int64, DefaultValue: 0}, {Key: "monthly_third_party_events", ValueType: schema.Int64, DefaultValue: 0}}

func (r *CloudwatchEventBusItem) PopulateUsage(u *schema.UsageData) {
	resources.PopulateArgsWithUsage(r, u)
}

func (r *CloudwatchEventBusItem) BuildResource() *schema.Resource {
	region := *r.Region

	var monthlyCustomEvents *decimal.Decimal
	if r != nil && r.MonthlyCustomEvents != nil {
		monthlyCustomEvents = decimalPtr(decimal.NewFromInt(*r.MonthlyCustomEvents))
	}
	var monthlyPartnerEvents *decimal.Decimal
	if r != nil && r.MonthlyThirdPartyEvents != nil {
		monthlyPartnerEvents = decimalPtr(decimal.NewFromInt(*r.MonthlyThirdPartyEvents))
	}
	var monthlyArchiveProcessing *decimal.Decimal
	if r != nil && r.MonthlyArchiveProcessingGb != nil {
		monthlyArchiveProcessing = decimalPtr(decimal.NewFromInt(*r.MonthlyArchiveProcessingGb))
	}
	var monthlyArchivedEvents *decimal.Decimal
	if r != nil && r.ArchiveStorageGb != nil {
		monthlyArchivedEvents = decimalPtr(decimal.NewFromInt(*r.ArchiveStorageGb))
	}
	var monthlyIngestedEvents *decimal.Decimal
	if r != nil && r.MonthlySchemaDiscoveryEvents != nil {
	...
	return &schema.Resource{
		...
		}, UsageSchema: CloudwatchEventBusItemUsageSchema,
	}
}
