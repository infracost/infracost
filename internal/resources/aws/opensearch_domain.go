...
var OpensearchDomainUsageSchema = []*schema.UsageItem{}

func (r *OpensearchDomain) PopulateUsage(u *schema.UsageData) {
	resources.PopulateArgsWithUsage(r, u)
}

func (r *OpensearchDomain) BuildResource() *schema.Resource {
	defaultClusterInstanceType := "t3.small.search"
	...
	return &schema.Resource{
		...
		UsageSchema:    OpensearchDomainUsageSchema,
	}
}

func (r *OpensearchDomain) opensearchifyClusterInstanceType(instanceType string) *string {
