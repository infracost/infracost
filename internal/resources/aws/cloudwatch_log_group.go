...
var CloudwatchLogGroupItemUsageSchema = []*schema.UsageItem{{Key: "monthly_data_ingested_gb", ValueType: schema.Float64, DefaultValue: 0}, {Key: "storage_gb", ValueType: schema.Float64, DefaultValue: 0}, {Key: "monthly_data_scanned_gb", ValueType: schema.Float64, DefaultValue: 0}}

func (r *CloudwatchLogGroupItem) PopulateUsage(u *schema.UsageData) {
	resources.PopulateArgsWithUsage(r, u)
}

func (r *CloudwatchLogGroupItem) BuildResource() *schema.Resource {
	region := *r.Region
	...
	if r != nil && r.MonthlyDataIngestedGb != nil {
	...
	if r != nil && r.MonthlyDataScannedGb != nil {
	...
	return &schema.Resource{
		...
		}, UsageSchema: CloudwatchLogGroupItemUsageSchema,
	}
}
