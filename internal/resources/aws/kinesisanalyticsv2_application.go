...
type KinesisDataAnalytics struct {
	Address                    *string
	Region                     *string
...
var KinesisDataAnalyticsUsageSchema = []*schema.UsageItem{{Key: "kinesis_processing_units", ValueType: schema.Int64, DefaultValue: 0}, {Key: "durable_application_backup_gb", ValueType: schema.Int64, DefaultValue: 0}}

func (r *KinesisDataAnalytics) PopulateUsage(u *schema.UsageData) {
	resources.PopulateArgsWithUsage(r, u)
}

func (r *KinesisDataAnalytics) BuildResource() *schema.Resource {
	region := *r.Region
	...
	return &schema.Resource{
		Name:           *r.Address,
		CostComponents: costComponents, UsageSchema: KinesisDataAnalyticsUsageSchema,
	}
}
