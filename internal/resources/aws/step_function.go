...
var StepFunctionUsageSchema = []*schema.UsageItem{{Key: "memory_mb", ValueType: schema.Int64, DefaultValue: 0}, {Key: "monthly_transitions", ValueType: schema.Int64, DefaultValue: 0}, {Key: "monthly_requests", ValueType: schema.Int64, DefaultValue: 0}, {Key: "workflow_duration_ms", ValueType: schema.Int64, DefaultValue: 0}}

func (r *StepFunction) PopulateUsage(u *schema.UsageData) {
	resources.PopulateArgsWithUsage(r, u)
}

func (r *StepFunction) BuildResource() *schema.Resource {
	region := *r.Region
	...
	if strings.ToLower(tier) == "standard" {
		if r != nil && r.MonthlyTransitions != nil {
	...
	return &schema.Resource{
		Name:           *r.Address,
		CostComponents: costComponents, UsageSchema: StepFunctionUsageSchema,
	}
}
