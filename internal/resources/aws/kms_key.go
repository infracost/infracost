...
type NewKMSKey struct {
	Address               *string
	Region                *string
	CustomerMasterKeySpec *string
}

var NewKMSKeyUsageSchema = []*schema.UsageItem{}

func (r *NewKMSKey) PopulateUsage(u *schema.UsageData) {
	resources.PopulateArgsWithUsage(r, u)
}

func (r *NewKMSKey) BuildResource() *schema.Resource {
	...
	return &schema.Resource{
		Name:           *r.Address,
		CostComponents: costComponents, UsageSchema: NewKMSKeyUsageSchema,
	}
}
