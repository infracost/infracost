...
type MQBroker struct {
	...
	StorageSizeGb    *int64 `infracost_usage:"storage_size_gb"`
}

var MQBrokerUsageSchema = []*schema.UsageItem{{Key: "storage_size_gb", ValueType: schema.Int64, DefaultValue: 0}}
...
func (r *MQBroker) BuildResource() *schema.Resource {
	...
	if r != nil && r.StorageSizeGb != nil {
		storageSizeGB = decimalPtr(decimal.NewFromInt(*r.StorageSizeGb))
	}
