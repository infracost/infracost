...
type ConfigOrganizationManagedRuleItem struct {
	Address                *string
	Region                 *string
	MonthlyRuleEvaluations *int64 `infracost_usage:"monthly_rule_evaluations"`
}

var ConfigOrganizationManagedRuleItemUsageSchema = []*schema.UsageItem{{Key: "monthly_rule_evaluations", ValueType: schema.Int64, DefaultValue: 0}}

func (r *ConfigOrganizationManagedRuleItem) PopulateUsage(u *schema.UsageData) {
	resources.PopulateArgsWithUsage(r, u)
}

func (r *ConfigOrganizationManagedRuleItem) BuildResource() *schema.Resource {
	region := *r.Region
	...
	return &schema.Resource{
		Name:           *r.Address,
		CostComponents: costComponents, UsageSchema: ConfigOrganizationManagedRuleItemUsageSchema,
	}
}
