...
var ConfigOrganizationCustomRuleUsageSchema = []*schema.UsageItem{{Key: "monthly_rule_evaluations", ValueType: schema.Int64, DefaultValue: 0}}

func (r *ConfigOrganizationCustomRule) PopulateUsage(u *schema.UsageData) {
	resources.PopulateArgsWithUsage(r, u)
}

func (r *ConfigOrganizationCustomRule) BuildResource() *schema.Resource {
	region := *r.Region
	...
	return &schema.Resource{
		Name:           *r.Address,
		CostComponents: costComponents, UsageSchema: ConfigOrganizationCustomRuleUsageSchema,
	}
}
