...
func GetAutoscalingGroupRegistryItemOld() *schema.RegistryItem {
	return &schema.RegistryItem{
		Name:  "aws_autoscaling_group",
		RFunc: NewAutoscalingGroupOld,
...
func NewAutoscalingGroupOld(d *schema.ResourceData, u *schema.UsageData) *schema.Resource {
