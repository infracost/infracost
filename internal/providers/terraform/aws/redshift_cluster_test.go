...
`
	...
	usage := schema.NewUsageMap(map[string]interface{}{
		"aws_redshift_cluster.ca": map[string]interface{}{
			"excess_concurrency_scaling_sec": 4321,
	...
	resourceChecks := []testutil.ResourceCheck{
		{
			...
			CostComponentChecks: []testutil.CostComponentCheck{
				{
					Name:            "Redshift Cluster (on-demand, dc2.large)",
				...
				{
					Name:            "Redshift Concurrency Scaling (dc2.large)",
					PriceHash:       "ac168057c0de84c734f1e73076bf9c17-1786dd5ddb52682e127baa00bfaa4c48",
					HourlyCostCheck: testutil.MonthlyPriceMultiplierCheck(decimal.NewFromInt(4 * 4321)),
				},
				{
					Name:            "Redshift Spectrum",
					PriceHash:       "34795c8357acd40ec5f6308d75e733ea-665524fe1a13b69627c1f48ee6dcc45c",
					HourlyCostCheck: testutil.MonthlyPriceMultiplierCheck(decimal.NewFromFloat(0.5)),
				},
				{
					Name:            "Backup Storage (first 50 TB)",
					PriceHash:       "d991ea538483f74fd655b3233c61b427-ee3dd7e4624338037ca6fea0933a662f",
					HourlyCostCheck: testutil.MonthlyPriceMultiplierCheck(decimal.NewFromInt(51200)),
				},
				{
					Name:            "Backup Storage (next 450 TB)",
					PriceHash:       "d991ea538483f74fd655b3233c61b427-ee3dd7e4624338037ca6fea0933a662f",
					HourlyCostCheck: testutil.MonthlyPriceMultiplierCheck(decimal.NewFromInt(512000)),
				},
				{
					Name:            "Backup Storage (over 500 TB)",
					PriceHash:       "d991ea538483f74fd655b3233c61b427-ee3dd7e4624338037ca6fea0933a662f",
					HourlyCostCheck: testutil.MonthlyPriceMultiplierCheck(decimal.NewFromInt(48800)),
				},
			},
		},
		{
			...
			CostComponentChecks: []testutil.CostComponentCheck{
				{
					Name:            "Redshift Cluster (on-demand, ds2.8xlarge)",
	...
	resourceChecks := []testutil.ResourceCheck{
		{
			...
			CostComponentChecks: []testutil.CostComponentCheck{
				{
					Name:            "Redshift Cluster (on-demand, ra3.4xlarge)",
		...
		},
		{
			...
			CostComponentChecks: []testutil.CostComponentCheck{
				{
					Name:            "Redshift Cluster (on-demand, ra3.16xlarge)",
