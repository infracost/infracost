...
func TestS3Bucket_usage(t *testing.T) {
	if testing.Short() {
		t.Skip("skipping test in short mode")
	}
	...
	usage := schema.NewUsageMap(map[string]interface{}{
		"aws_s3_bucket.bucket1": map[string]interface{}{
			"monthly_object_tags": 1000,
			"standard": map[string]interface{}{
				"monthly_data_storage_gb":         10000,
				"monthly_pcpl_requests":           10000,
				"monthly_all_other_requests":      10000,
				"monthly_select_data_scanned_gb":  10000,
				"monthly_select_data_returned_gb": 10000,
			},
			"intelligent_tiering": map[string]interface{}{
				"monthly_frequent_access_storage_gb":    20000,
				"monthly_infrequent_access_storage_gb":  20000,
				"monthly_pcpl_requests":                 20000,
				"monthly_all_other_requests":            20000,
				"monthly_select_data_scanned_gb":        20000,
				"monthly_select_data_returned_gb":       20000,
				"monthly_monitoring_automation_objects": 20000,
				"monthly_lifecycle_requests":            20000,
				"early_data_delete_gb":                  20000,
			},
			"standard_infrequent_access": map[string]interface{}{
				"monthly_data_storage_gb":         30000,
				"monthly_pcpl_requests":           30000,
				"monthly_all_other_requests":      30000,
				"monthly_lifecycle_requests":      30000,
				"monthly_retrievals_gb":           30000,
				"monthly_select_data_scanned_gb":  30000,
				"monthly_select_data_returned_gb": 30000,
			},
			"one_zone_infrequent_access": map[string]interface{}{
				"monthly_data_storage_gb":         40000,
				"monthly_pcpl_requests":           40000,
				"monthly_all_other_requests":      40000,
				"monthly_lifecycle_requests":      40000,
				"monthly_retrievals_gb":           40000,
				"monthly_select_data_scanned_gb":  40000,
				"monthly_select_data_returned_gb": 40000,
			},
			"glacier": map[string]interface{}{
				"monthly_data_storage_gb":                   50000,
				"monthly_pcpl_requests":                     50000,
				"monthly_all_other_requests":                50000,
				"monthly_lifecycle_requests":                50000,
				"monthly_standard_select_data_scanned_gb":   50000,
				"monthly_standard_select_data_returned_gb":  50000,
				"monthly_bulk_select_data_scanned_gb":       50000,
				"monthly_bulk_select_data_returned_gb":      50000,
				...
				"monthly_standard_data_retrievals_gb":       50000,
				"monthly_bulk_data_retrievals_gb":           50000,
				"monthly_expedited_data_retrievals_gb":      50000,
				"early_data_delete_gb":                      50000,
			},
			"glacier_deep_archive": map[string]interface{}{
				"monthly_data_storage_gb":                  60000,
				"monthly_pcpl_requests":                    60000,
				"monthly_all_other_requests":               60000,
				"monthly_lifecycle_requests":               60000,
				"monthly_standard_data_retrieval_requests": 60000,
				"monthly_bulk_data_retrieval_requests":     60000,
				"monthly_standard_data_retrievals_gb":      60000,
				"monthly_bulk_data_retrievals_gb":          60000,
				"early_data_delete_gb":                     60000,
			},
		},
	})
					...
					CostComponentChecks: []testutil.CostComponentCheck{
						{
							Name:             "Storage (frequent access)",
							PriceHash:        "07a918cb6025bc4db80666ef0e66e0b5-ee3dd7e4624338037ca6fea0933a662f",
							MonthlyCostCheck: testutil.MonthlyPriceMultiplierCheck(decimal.NewFromFloat(20000)),
						},
						{
							Name:             "Storage (infrequent access)",
							PriceHash:        "5c80e08ae0fc926e1adb9112a6efcb2e-ee3dd7e4624338037ca6fea0933a662f",
					...
					CostComponentChecks: []testutil.CostComponentCheck{
						{
							Name:             "Storage",
							PriceHash:        "fb14131eed9cc90c1a1b39af0241c9c1-ee3dd7e4624338037ca6fea0933a662f",
							MonthlyCostCheck: testutil.MonthlyPriceMultiplierCheck(decimal.NewFromFloat(30000)),
						},
						{
							Name:             "PUT, COPY, POST, LIST requests",
							PriceHash:        "446853cc37182cdc098bcfddeedbefea-4a9dfd3965ffcbab75845ead7a27fd47",
					...
					CostComponentChecks: []testutil.CostComponentCheck{
						{
							Name:             "Storage",
							PriceHash:        "d4ca3a7b652c57630e78ed91933d869f-ee3dd7e4624338037ca6fea0933a662f",
							MonthlyCostCheck: testutil.MonthlyPriceMultiplierCheck(decimal.NewFromFloat(40000)),
						},
						{
							Name:             "PUT, COPY, POST, LIST requests",
							PriceHash:        "d3387b07454cd9fcfa7e87cc975e93fc-4a9dfd3965ffcbab75845ead7a27fd47",
					...
					CostComponentChecks: []testutil.CostComponentCheck{
						{
							Name:             "Storage",
							PriceHash:        "91a960e141a8c8ae5ac93089e4be4fd8-ee3dd7e4624338037ca6fea0933a662f",
							MonthlyCostCheck: testutil.MonthlyPriceMultiplierCheck(decimal.NewFromFloat(50000)),
						},
						{
							Name:             "PUT, COPY, POST, LIST requests",
							PriceHash:        "02e559a7fcbd024b096e7f9b0db98641-4a9dfd3965ffcbab75845ead7a27fd47",
					...
					CostComponentChecks: []testutil.CostComponentCheck{
						{
							Name:             "Storage",
							PriceHash:        "e20face2e1716d8b58fec20e7ac85098-ee3dd7e4624338037ca6fea0933a662f",
							MonthlyCostCheck: testutil.MonthlyPriceMultiplierCheck(decimal.NewFromFloat(60000)),
						},
						{
							Name:             "PUT, COPY, POST, LIST requests",
							PriceHash:        "6fefcf21312acdbdee7dfe139154077e-4a9dfd3965ffcbab75845ead7a27fd47",
