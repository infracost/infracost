...
`
	...
	resourceChecks := []testutil.ResourceCheck{
		...
		{
			Name: "azurerm_app_service_plan.pc2",
			CostComponentChecks: []testutil.CostComponentCheck{
				{
					Name:            "Instance usage (PC2)",
					PriceHash:       "1c01cdcc1d057be820d186cd68211ae8-60fc60896424f2f0b576ec5c4e380288",
					HourlyCostCheck: testutil.HourlyPriceMultiplierCheck(decimal.NewFromInt(1)),
				},
			},
		},
		{
			Name: "azurerm_app_service_plan.pc3",
			CostComponentChecks: []testutil.CostComponentCheck{
				{
					Name:            "Instance usage (PC3)",
					PriceHash:       "7931a64412b361fa4fa634b3fe83fdeb-60fc60896424f2f0b576ec5c4e380288",
					HourlyCostCheck: testutil.HourlyPriceMultiplierCheck(decimal.NewFromInt(15)),
				},
			},
		},
