...
resource "azurerm_app_service_environment" "example" {
  ...
  resource "azurerm_app_service_environment" "example3" {
	name                         = "example-ase"
	subnet_id                    = azurerm_subnet.ase.id
	pricing_tier                 = "I1"
	front_end_scale_factor       = 10
  ...
  resource "azurerm_app_service_environment" "example4" {
	name                         = "example-ase"
	subnet_id                    = azurerm_subnet.ase.id
	pricing_tier                 = "I2"
	front_end_scale_factor       = 10
...
`
	...
	resourceChecks := []testutil.ResourceCheck{
		...
		{
			Name: "azurerm_app_service_environment.example3",
			CostComponentChecks: []testutil.CostComponentCheck{
				{
					Name:            "Stamp fee",
					PriceHash:       "b74a7d0a1aca40309bb9ad96939232c7-60fc60896424f2f0b576ec5c4e380288",
		...
		{
			Name: "azurerm_app_service_environment.example4",
			CostComponentChecks: []testutil.CostComponentCheck{
				{
					Name:            "Stamp fee",
					PriceHash:       "b74a7d0a1aca40309bb9ad96939232c7-60fc60896424f2f0b576ec5c4e380288",
