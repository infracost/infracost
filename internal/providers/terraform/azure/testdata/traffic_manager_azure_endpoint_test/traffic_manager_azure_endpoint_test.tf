...
resource "azurerm_traffic_manager_azure_endpoint" "default_healthcheck_example" {
...
resource "azurerm_traffic_manager_azure_endpoint" "basic_healthcheck_example" {
  name               = "example-endpoint"
...
resource "azurerm_traffic_manager_azure_endpoint" "fast_healthcheck_example" {
  name               = "example-endpoint"
...
resource "azurerm_traffic_manager_azure_endpoint" "disabled_example" {
  name               = "example-endpoint"
...
resource "azurerm_traffic_manager_azure_endpoint" "germany_example" {
  name               = "example-endpoint"
