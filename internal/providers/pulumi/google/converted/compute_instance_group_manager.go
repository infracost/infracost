...
func getComputeInstanceGroupManagerRegistryItem() *schema.RegistryItem {
	return &schema.RegistryItem{
		...
		ReferenceAttributes: []string{"version.0.instanceTemplate", "googleComputePerInstanceConfig.instanceGroupManager"},
...
func newComputeInstanceGroupManager(d *schema.ResourceData) schema.CoreResource {
	...
	if len(d.References("googleComputePerInstanceConfig.instanceGroupManager")) > 0 {
		targetSize += int64(len(d.References("googleComputePerInstanceConfig.instanceGroupManager")))
	}
