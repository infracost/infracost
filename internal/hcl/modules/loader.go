...
func RecursivelyAddDirsToSparseCheckout(repoRoot string, sourceURL *url.URL, packageFetcher *PackageFetcher, existingDirs []string, dirs []string, mu *sync.Mutex, logger zerolog.Logger, depth int) error {
	var newDirs []string
