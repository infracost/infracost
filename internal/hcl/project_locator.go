...
func NewProjectLocator(logger *logrus.Entry, excludedDirs []string) *ProjectLocator {
...
func (p *ProjectLocator) FindRootModules(fullPath string) []string {
	...
	p.logger.Debugf("walking directory at %s returned a list of possible Terraform projects: %+v", dirs)
