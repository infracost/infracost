...
require (
	...
	github.com/gruntwork-io/terragrunt-engine-go v0.0.2 // indirect
...
replace github.com/gruntwork-io/terragrunt => github.com/infracost/terragrunt v0.47.1-0.20240829091135-3527c69ccc18
