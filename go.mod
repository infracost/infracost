...
replace github.com/gruntwork-io/terragrunt => github.com/infracost/terragrunt v0.47.1-0.20241113221233-646f9b92d1fe
...
replace github.com/hashicorp/go-getter => github.com/infracost/go-getter v0.0.0-20241113193122-eeeb4e90c01c
