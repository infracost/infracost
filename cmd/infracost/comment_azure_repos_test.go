...
func TestCommentAzureReposCommentPath(t *testing.T) {
	GoldenFileCommandTest(t, testutil.CalcGoldenFileTestdataDirName(),
		[]string{"comment", "azure-repos", "--azure-access-token", "abc", "--repo-url", "https://dev.azure.com/my-org/my-project/_git/my-azure-repo", "--pull-request", "5", "--comment-path", "./testdata/comment.md", "--dry-run"},
		nil)
}
